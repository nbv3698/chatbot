...
(this.s.autoHeight=!1);this.fnMeasure(!1);this.s.ingnoreScroll=!0;this.s.stateSaveThrottle=this.s.dt.oApi._fnThrottle(function(){a.s.dt.oApi._fnSaveState(a.s.dt)},500);e(this.dom.scroller).on("http://www.eakroko.de/flat/js/plugins/datatables/extensions/scroll.DTS",function(){a._fnScroll.call(a)});e(this.dom.scroller).on("http://www.eakroko.de/flat/js/plugins/datatables/extensions/touchstart.DTS",function(){a._fnScroll.call(a)});this.s.dt.aoDrawCallback.push({fn:function(){a.s.dt.bInitialised&&a._fnDrawCallback.call(a)},sName:"Scroller"});e(m).on("http://www.eakroko.de/flat/js/plugins/datatables/extensions/resize.DTS",function(){a.fnMeasure(false);a._fnInfo()});var b=!0;this.s.dt.oApi._fnCallbackReg(this.s.dt,
"aoStateSaveParams",function(c,d){if(b&&a.s.dt.oLoadedState){d.iScroller=a.s.dt.oLoadedState.iScroller;d.iScrollerTopRow=a.s.dt.oLoadedState.iScrollerTopRow;b=false}else{d.iScroller=a.dom.scroller.scrollTop;d.iScrollerTopRow=a.s.topRowFloat}},"Scroller_State");this.s.dt.oLoadedState&&(this.s.topRowFloat=this.s.dt.oLoadedState.iScrollerTopRow||0);this.s.dt.aoDestroyCallback.push({sName:"Scroller",fn:function(){e(m).off("http://www.eakroko.de/flat/js/plugins/datatables/extensions/resize.DTS");e(a.dom.scroller).off("http://www.eakroko.de/flat/js/plugins/datatables/extensions/touchstart.DTS scroll.DTS");e(a.s.dt.nTableWrapper).removeClass("DTS");
