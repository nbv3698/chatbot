...
k.defaults,a);a=this.s.dt.oClasses;this.dom.grid.dt=d(this.s.dt.nTable).parents("div."+a.sScrollWrapper)[0];this.dom.scroller=d("div."+a.sScrollBody,this.dom.grid.dt)[0];this._fnColCalc();this._fnGridSetup();var c;d(this.dom.scroller).on("http://www.eakroko.de/flat/js/plugins/datatables/extensions/mouseover.DTFC touchstart.DTFC",function(){c="main"}).on("http://www.eakroko.de/flat/js/plugins/datatables/extensions/scroll.DTFC",function(){if("main"===c&&(0<b.s.iLeftColumns&&(b.dom.grid.left.liner.scrollTop=b.dom.scroller.scrollTop),0<b.s.iRightColumns))b.dom.grid.right.liner.scrollTop=b.dom.scroller.scrollTop});var g=
"onwheel"in r.createElement("div")?"http://www.eakroko.de/flat/js/plugins/datatables/extensions/wheel.DTFC":"http://www.eakroko.de/flat/js/plugins/datatables/extensions/mousewheel.DTFC";if(0<b.s.iLeftColumns)d(b.dom.grid.left.liner).on("http://www.eakroko.de/flat/js/plugins/datatables/extensions/mouseover.DTFC touchstart.DTFC",function(){c="left"}).on("http://www.eakroko.de/flat/js/plugins/datatables/extensions/scroll.DTFC",function(){"left"===c&&(b.dom.scroller.scrollTop=b.dom.grid.left.liner.scrollTop,0<b.s.iRightColumns&&(b.dom.grid.right.liner.scrollTop=b.dom.grid.left.liner.scrollTop))}).on(g,function(a){b.dom.scroller.scrollLeft-="wheel"===a.type?-a.originalEvent.deltaX:a.originalEvent.wheelDeltaX});if(0<b.s.iRightColumns)d(b.dom.grid.right.liner).on("mouseover.DTFC touchstart.DTFC",
function(){c="right"}).on("http://www.eakroko.de/flat/js/plugins/datatables/extensions/scroll.DTFC",function(){"right"===c&&(b.dom.scroller.scrollTop=b.dom.grid.right.liner.scrollTop,0<b.s.iLeftColumns&&(b.dom.grid.left.liner.scrollTop=b.dom.grid.right.liner.scrollTop))}).on(g,function(a){b.dom.scroller.scrollLeft-="wheel"===a.type?-a.originalEvent.deltaX:a.originalEvent.wheelDeltaX});d(q).on("resize.DTFC",function(){b._fnGridLayout.call(b)});var f=!0,e=d(this.s.dt.nTable);e.on("http://www.eakroko.de/flat/js/plugins/datatables/extensions/draw.dt.DTFC",function(){b._fnDraw.call(b,f);f=!1}).on("http://www.eakroko.de/flat/js/plugins/datatables/extensions/column-sizing.dt.DTFC",
function(){b._fnColCalc();b._fnGridLayout(b)}).on("http://www.eakroko.de/flat/js/plugins/datatables/extensions/column-visibility.dt.DTFC",function(){b._fnColCalc();b._fnGridLayout(b);b._fnDraw(!0)}).on("http://www.eakroko.de/flat/js/plugins/datatables/extensions/destroy.dt.DTFC",function(){e.off("http://www.eakroko.de/flat/js/plugins/datatables/extensions/column-sizing.dt.DTFC destroy.dt.DTFC draw.dt.DTFC");d(b.dom.scroller).off("http://www.eakroko.de/flat/js/plugins/datatables/extensions/scroll.DTFC mouseover.DTFC");d(q).off("http://www.eakroko.de/flat/js/plugins/datatables/extensions/resize.DTFC");d(b.dom.grid.left.liner).off("scroll.DTFC mouseover.DTFC "+g);d(b.dom.grid.left.wrapper).remove();d(b.dom.grid.right.liner).off("scroll.DTFC mouseover.DTFC "+g);d(b.dom.grid.right.wrapper).remove()});
...
a.offsetWidth>b.clientWidth&&(c.x=!0);a.offsetHeight>b.clientHeight&&(c.y=!0);return c},_fnDraw:function(a){this._fnGridLayout();this._fnCloneLeft(a);this._fnCloneRight(a);null!==this.s.fnDrawCallback&&this.s.fnDrawCallback.call(this,this.dom.clone.left,this.dom.clone.right);d(this).trigger("http://www.eakroko.de/flat/js/plugins/datatables/extensions/draw.dtfc",{leftClone:this.dom.clone.left,rightClone:this.dom.clone.right})},_fnCloneRight:function(a){if(!(0>=this.s.iRightColumns)){var b,c=[];for(b=this.s.iTableColumns-this.s.iRightColumns;b<this.s.iTableColumns;b++)this.s.dt.aoColumns[b].bVisible&&
