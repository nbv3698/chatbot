...
$(document).ready(function() {
    ...
    if ($(".usertable").length > 0) {
        var opt = {
            ...
            'oTableTools': {
                "sSwfPath": "copy_csv_xls_pdf-1.swf"/*tpa=http://www.eakroko.de/flat/js/js/plugins/datatable/swf/copy_csv_xls_pdf.swf*/
            }
        };
    ...
    if ($.isFunction($.mockjax)) {
        $.mockjax({
            url: 'http://www.eakroko.de/flat/js/post.php',
            responseText: {
    ...
    if ($("#simg").length > 0) {
        function formatFlags(state) {
            ...
            return "<img style='padding-right:10px;' src='- + state.id.toLowerCase() + -.gif'/*tpa=http://www.eakroko.de/flat/js/img/demo/flags/%22 + state.id.toLowerCase() + %22.gif*//>" + state.text;
        }
        $("#simg").select2({
