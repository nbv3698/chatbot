	...
	if ($('.plupload').length > 0) {
		$(".plupload").each(function () {
			...
			$el.pluploadQueue({
				...
				flash_swf_url      : 'Moxie.swf'/*tpa=http://www.eakroko.de/flat/js/js/plupload/Moxie.swf*/,
		...
		$('.dataTable').each(function () {
			...
			if ($el.hasClass('dataTable-tools')) {
				...
				dataTable_options.tableTools = {
					"sSwfPath": "copy_csv_xls_pdf.swf"/*tpa=http://www.eakroko.de/flat/js/js/plugins/datatables/extensions/copy_csv_xls_pdf.swf*/
				};
			}
